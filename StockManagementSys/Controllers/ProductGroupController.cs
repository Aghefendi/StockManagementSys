...
namespace StockManagementSys.Controllers
{
    ...
    public class ProductGroupController : Controller
    {
        ...
        public ProductGroupController(IProductGroup productGroup)
        {
        ...
        public IActionResult Index(string sortExpression = "", string SearchText = "", int pg = 1, int pageSize = 5)
        {
            ...
            List<ProductGroup> items = _productGroup.GetItems(sortModel.SortProperty, sortModel.SortOrder, SearchText, pg, pageSize);//_context.Units.ToList();
            int totRecors = ((PaginatedList<ProductGroup>)items).TotalRecords;
        ...
        public IActionResult Create(ProductGroup items)
        {
            ...
            try
            {
                items = _productGroup.Create(items);
        ...
        {
            ProductGroup items = _productGroup.GetItem(id);
            return View(items);
        ...
        public IActionResult Edit(ProductGroup items)
        {
            ...
            try
            {
                items = _productGroup.Edit(items);
        ...
        public IActionResult Delete(ProductGroup items)
        {
            ...
            try
            {
                ...
                items = _productGroup.Delete(items);
