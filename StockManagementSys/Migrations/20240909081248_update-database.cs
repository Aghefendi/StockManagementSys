        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InwardDetalId = table.Column<int>(type: "int", nullable: false),
                    PoDetalId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ControlChecks_InwardDetail_InwardDetalId",
                        column: x => x.InwardDetalId,
                        principalTable: "InwardDetail",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ControlChecks_PoDetails_PoDetalId",
                        column: x => x.PoDetalId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ControlChecks_InwardDetalId",
                table: "ControlChecks",
                column: "InwardDetalId");
